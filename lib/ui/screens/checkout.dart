  ...
  Widget _buildMethodTextField(model) {
    return Padding(
      ...
      child: DropDownFormField(
        titleText: 'طريقة الدفع او السداد',
        hintText: 'إختر واحد من فضلك',
        ...
        dataSource: [
          {
            "display": 'الدفع عند الاستلام',
            "value": 'cashOnDelivery',
          },
          {
            "display": 'بطاقة ائتمان',
            "value": 'visa',
          }
        ],
        textField: 'display',
                    ...
                    children: <Widget>[
                      ...
                      Container(
                        ...
                        child: RaisedButton(
                            ...
                            child: Text('استمر'),
                            onPressed: () {
                              if (_formData['gateway'] == '' ||
                                  _formData['address_id'] == '') {
                                model.showFlushBar(
                                    context, 'الرجاء اختيار البيانات الخاصة بك');
                              } else {
                                setState(() {
                                  print(_formData);
