...
class _AppBottomNavigationBarState extends State<AppBottomNavigationBar> {
  ...
  Widget build(BuildContext context) {
    return BottomNavigationBar(
      ...
      items: [
        BottomNavigationBarItem(icon: Icon(Icons.home), title: Text("الصفحة الرئيسية")),
        BottomNavigationBarItem(
            icon: Icon(Icons.category), title: Text("التصنيفات")),
        BottomNavigationBarItem(
            icon: Icon(Icons.book), title: Text("المتجر")),
        BottomNavigationBarItem(
            icon: Icon(Icons.account_circle), title: Text('حسابي')),
      ],
    );
  }
}
