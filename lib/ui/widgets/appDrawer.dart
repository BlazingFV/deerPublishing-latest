...
class _AppDrawerState extends State<AppDrawer>
  ...
  String author = "";
  String age = "";
  bool checkBoxValueGetter;
  bool checkBoxValueSetter;
  bool valuee;
  var timeDilation;
  SharedPreferences _prefs;
  getCheckBoxesValues() async {
    _prefs = await SharedPreferences.getInstance();
    checkBoxValueSetter = await _prefs.setBool('checked', valuee);
    checkBoxValueGetter = await _prefs.getBool('checked');
  }
    ...
    return showDialog(
        ...
        builder: (context) {
          return AlertDialog(
            ...
            content: pointss == null
                ? Center(
                    child: Container(
                        width: 50,
                        height: 50,
                        child: CircularProgressIndicator()))
                : Text('لديك $pointss نقطة'),
            actions: <Widget>[
              MaterialButton(
                color: Theme.of(context).primaryColor,
                child: Text('ok'),
                    ...
                    child: ListView(
                      children: <Widget>[
                        ...
                        GFAccordion(
                            ...
                            contentChild: Column(
                                children:
                                    _filterCategories(widget.categories))),
                        GFAccordion(
                            title: 'المؤلفون',
                            contentChild: Column(
                                children: _filterAuthors(widget.authors))),
                        GFAccordion(
                            title: 'اللغات',
                            contentChild: Column(
                                children: _filterLnaguages(widget.languages))),
                        GFAccordion(
                            title: 'الأعمار',
                            contentChild:
                                Column(children: _filterAges(widget.ages))),
                        ListTile(
                          trailing: Icon(
